...
F2(_JsArray_initializeFromList_fn);
var _JsArray_unsafeGet_fn = function(index, array) {
  return array[index];
};
F2(_JsArray_unsafeGet_fn);
...
F2(_Utils_eq);
var _Utils_notEqual_fn = function(a, b) {
  return !_Utils_eq(a, b);
};
F2(_Utils_notEqual_fn);
...
var _Utils_lt_fn = function(a, b) {
  return _Utils_cmp(a, b) < 0;
};
F2(_Utils_lt_fn);
var _Utils_le_fn = function(a, b) {
  return _Utils_cmp(a, b) < 1;
};
F2(_Utils_le_fn);
var _Utils_gt_fn = function(a, b) {
  return _Utils_cmp(a, b) > 0;
};
F2(_Utils_gt_fn);
var _Utils_ge_fn = function(a, b) {
  return _Utils_cmp(a, b) >= 0;
};
F2(_Utils_ge_fn);
...
F2(_List_sortWith_fn);
var _Basics_add_fn = function(a, b) {
  return a + b;
};
F2(_Basics_add_fn);
var _Basics_sub_fn = function(a, b) {
  return a - b;
};
F2(_Basics_sub_fn);
var _Basics_mul_fn = function(a, b) {
  return a * b;
};
F2(_Basics_mul_fn);
var _Basics_fdiv_fn = function(a, b) {
  return a / b;
};
F2(_Basics_fdiv_fn);
var _Basics_idiv_fn = function(a, b) {
  return a / b | 0;
};
F2(_Basics_idiv_fn);
var _Basics_pow_fn = Math.pow;
F2(_Basics_pow_fn);
var _Basics_remainderBy_fn = function(b, a) {
  return a % b;
};
F2(_Basics_remainderBy_fn);
...
F2(_Basics_modBy_fn);
var _Basics_atan2_fn = Math.atan2;
F2(_Basics_atan2_fn);
...
var _Basics_and_fn = function(a, b) {
  return a && b;
};
F2(_Basics_and_fn);
var _Basics_or_fn = function(a, b) {
  return a || b;
};
F2(_Basics_or_fn);
var _Basics_xor_fn = function(a, b) {
  return a !== b;
};
F2(_Basics_xor_fn);
...
function _Json_toElmArray(array) {
  return $elm$core$Array$initialize_fn(array.length, function(i) {
    return array[i];
  });
}
...
var _Platform_worker_fn = function(impl, flagDecoder, debugMetadata, args) {
  return _Platform_initialize(flagDecoder, args, impl.a2, impl.bn, impl.bh, function() {
    return function() {
    };
  });
}, _Platform_worker = F4(_Platform_worker_fn);
function _Platform_initialize(flagDecoder, args, init, update, subscriptions, stepperBuilder) {
  var result = _Json_run_fn(flagDecoder, _Json_wrap(args ? args["flags"] : void 0));
...
var _Platform_outgoingPortMap_fn = function(tagger, value) {
  return value;
}, _Platform_outgoingPortMap = F2(_Platform_outgoingPortMap_fn);
...
F2($elm$json$Json$Decode$Failure_fn);
var $elm$json$Json$Decode$Field_fn = function(a, b) {
  return { $: 0, a, b };
};
F2($elm$json$Json$Decode$Field_fn);
var $elm$json$Json$Decode$Index_fn = function(a, b) {
  return { $: 1, a, b };
};
F2($elm$json$Json$Decode$Index_fn);
...
F2($elm$core$List$indexedMap_fn);
...
F2($elm$core$Array$compressNodes_fn);
...
F2($elm$core$Array$treeFromBuilder_fn);
...
F2($elm$core$Array$builderToArray_fn);
...
F5($elm$core$Array$initializeHelp_fn);
...
F2($elm$core$Array$initialize_fn);
...
var $elm$json$Json$Encode$list_fn = function(func, entries) {
  return _Json_wrap($elm$core$List$foldl_fn(_Json_addEntry(func), _Json_emptyArray(), entries));
...
var $author$project$Parser$config = function() {
  var encodeType = F2(function(typeName, valueEncoder) {
    return $elm$json$Json$Encode$object(_List_fromArray([
      _Utils_Tuple2("type", $elm$json$Json$Encode$string(typeName)),
      _Utils_Tuple2("value", valueEncoder)
    ]));
  });
  return {
    aN: A2($elm$core$Basics$composeL, encodeType("Array"), $elm$json$Json$Encode$list($elm$core$Basics$identity)),
    aP: A2($elm$core$Basics$composeL, encodeType("Boolean"), $elm$json$Json$Encode$bool),
    aQ: A2($elm$core$Basics$composeL, encodeType("Bytes"), $elm$json$Json$Encode$int),
    aT: function(_char) {
      return $elm$json$Json$Encode$object(_List_fromArray([
        _Utils_Tuple2("type", $elm$json$Json$Encode$string("String")),
        _Utils_Tuple2("value", $elm$json$Json$Encode$string($elm$core$String$fromChar(_char)))
      ]));
    },
    aU: F2(function(name, values) {
      return $elm$core$List$isEmpty(values) ? $elm$json$Json$Encode$object(_List_fromArray([
        _Utils_Tuple2("type", $elm$json$Json$Encode$string("Type")),
        _Utils_Tuple2("name", $elm$json$Json$Encode$string(name))
      ])) : $elm$json$Json$Encode$object(_List_fromArray([
        _Utils_Tuple2("type", $elm$json$Json$Encode$string("Custom")),
        _Utils_Tuple2("name", $elm$json$Json$Encode$string(name)),
        _Utils_Tuple2("value", $elm$json$Json$Encode$list_fn($elm$core$Basics$identity, values))
      ]));
    }),
    aW: function(values) {
      return A2(encodeType, "Dict", $elm$json$Json$Encode$list_fn(function(_v0) {
        var k = _v0.a;
        var v = _v0.b;
        return $elm$json$Json$Encode$object(_List_fromArray([
          _Utils_Tuple2("key", k),
    ...
    a_: A2($elm$core$Basics$composeL, encodeType("File"), $elm$json$Json$Encode$string),
    a$: $elm$json$Json$Encode$object(_List_fromArray([
      _Utils_Tuple2("type", $elm$json$Json$Encode$string("Function"))
    ])),
    a3: $elm$json$Json$Encode$object(_List_fromArray([
      _Utils_Tuple2("type", $elm$json$Json$Encode$string("Internals"))
    ])),
    a5: A2($elm$core$Basics$composeL, encodeType("List"), $elm$json$Json$Encode$list($elm$core$Basics$identity)),
    a8: function(number) {
      return $elm$core$Basics$isNaN(number) ? A2(encodeType, "Number", $elm$json$Json$Encode$string("NaN")) : $elm$core$Basics$isInfinite(number) && number > 0 ? A2(encodeType, "Number", $elm$json$Json$Encode$string("Infinity")) : $elm$core$Basics$isInfinite(number) && number < 0 ? A2(encodeType, "Number", $elm$json$Json$Encode$string("-Infinity")) : A2(encodeType, "Number", $elm$json$Json$Encode$float(number));
    },
    bd: function(values) {
      return A2(encodeType, "Record", $elm$json$Json$Encode$object(values));
    },
    bf: A2($elm$core$Basics$composeL, encodeType("Set"), $elm$json$Json$Encode$list($elm$core$Basics$identity)),
    bg: A2($elm$core$Basics$composeL, encodeType("String"), $elm$json$Json$Encode$string),
    bl: A2($elm$core$Basics$composeL, encodeType("Tuple"), $elm$json$Json$Encode$list($elm$core$Basics$identity)),
    bm: $elm$json$Json$Encode$object(_List_fromArray([
      _Utils_Tuple2("type", $elm$json$Json$Encode$string("Unit"))
    ]))
  };
}();
var $kraklin$elm_debug_parser$DebugParser$ParsedLog_fn = function(tag, value) {
  return { bi: tag, bo: value };
}, $kraklin$elm_debug_parser$DebugParser$ParsedLog = F2($kraklin$elm_debug_parser$DebugParser$ParsedLog_fn);
var $elm$parser$Parser$Advanced$Bad_fn = function(a, b) {
  return { $: 1, a, b };
};
F2($elm$parser$Parser$Advanced$Bad_fn);
var $elm$parser$Parser$Advanced$Good_fn = function(a, b, c) {
  return { $: 0, a, b, c };
};
F3($elm$parser$Parser$Advanced$Good_fn);
var $elm$parser$Parser$Advanced$AddRight_fn = function(a, b) {
  return { $: 1, a, b };
};
F2($elm$parser$Parser$Advanced$AddRight_fn);
var $elm$parser$Parser$Advanced$DeadEnd_fn = function(row, col, problem, contextStack) {
  return { B: col, J: contextStack, E: problem, F: row };
};
F4($elm$parser$Parser$Advanced$DeadEnd_fn);
...
F4($elm$parser$Parser$Advanced$fromInfo_fn);
...
var $elm$parser$Parser$Advanced$chompUntil = function(_v0) {
  ...
  var expecting = _v0.b;
  return function(s) {
    var _v1 = _Parser_findSubString_fn(str, s.b, s.F, s.B, s.a);
    var newOffset = _v1.a;
    var newRow = _v1.b;
    var newCol = _v1.c;
    return newOffset === -1 ? $elm$parser$Parser$Advanced$Bad_fn(false, $elm$parser$Parser$Advanced$fromInfo_fn(newRow, newCol, expecting, s.c)) : $elm$parser$Parser$Advanced$Good_fn(_Utils_cmp(s.b, newOffset) < 0, 0, { B: newCol, c: s.c, e: s.e, b: newOffset, F: newRow, a: s.a });
  };
};
...
F2($elm$parser$Parser$Advanced$Token_fn);
...
F2($elm$core$List$map_fn);
var $kraklin$elm_debug_parser$DebugParser$deadEndsToString = function(deadEnds) {
  var deadEndToString = function(deadEnd) {
    var position = "row:" + ($elm$core$String$fromInt(deadEnd.F) + (" col:" + ($elm$core$String$fromInt(deadEnd.B) + "\n")));
    var _v0 = deadEnd.E;
    switch (_v0.$) {
      case 0:
        var str = _v0.a;
  ...
  return $elm$core$List$foldl_fn_unwrapped(function(str, acc) {
    return acc + ("\n" + str);
  }, "", $elm$core$List$map_fn(deadEndToString, deadEnds));
};
var $elm$parser$Parser$ExpectingEnd = { $: 10 };
var $elm$parser$Parser$Advanced$fromState_fn = function(s, x) {
  return $elm$parser$Parser$Advanced$AddRight_fn($elm$parser$Parser$Advanced$Empty, $elm$parser$Parser$Advanced$DeadEnd_fn(s.F, s.B, x, s.c));
};
F2($elm$parser$Parser$Advanced$fromState_fn);
...
F2($elm$parser$Parser$Advanced$mapChompedString_fn);
...
F3($elm$parser$Parser$Advanced$map2_fn);
...
F2($elm$parser$Parser$Advanced$ignorer_fn);
...
F2($elm$parser$Parser$Advanced$keeper_fn);
...
F2($elm$core$Result$mapError_fn);
...
F2($elm$parser$Parser$Advanced$andThen_fn);
...
F4($elm$parser$Parser$Advanced$loopHelp_fn);
...
F2($elm$parser$Parser$Advanced$loop_fn);
...
F2($elm$parser$Parser$Advanced$map_fn);
...
F2($elm$parser$Parser$loop_fn);
var $elm$parser$Parser$Advanced$Append_fn = function(a, b) {
  return { $: 2, a, b };
};
F2($elm$parser$Parser$Advanced$Append_fn);
...
F3($elm$parser$Parser$Advanced$oneOfHelp_fn);
...
var $elm$parser$Parser$Advanced$bumpOffset_fn = function(newOffset, s) {
  return { B: s.B + (newOffset - s.b), c: s.c, e: s.e, b: newOffset, F: s.F, a: s.a };
};
F2($elm$parser$Parser$Advanced$bumpOffset_fn);
...
F2($elm$parser$Parser$Advanced$consumeExp_fn);
...
F2($elm$parser$Parser$Advanced$consumeDotAndExp_fn);
var $elm$parser$Parser$Advanced$finalizeInt_fn = function(invalid, handler, startOffset, _v0, s) {
  ...
  if (handler.$ === 1) {
    ...
    return _Utils_eq(startOffset, endOffset) ? $elm$parser$Parser$Advanced$Bad_fn(_Utils_cmp(s.b, startOffset) < 0, $elm$parser$Parser$Advanced$fromState_fn(s, invalid)) : $elm$parser$Parser$Advanced$Good_fn(true, toValue(n), $elm$parser$Parser$Advanced$bumpOffset_fn(endOffset, s));
  }
};
F5($elm$parser$Parser$Advanced$finalizeInt_fn);
...
var $elm$parser$Parser$Advanced$finalizeFloat_fn = function(invalid, expecting, intSettings, floatSettings, intPair, s) {
  ...
  if (floatOffset < 0) {
    return $elm$parser$Parser$Advanced$Bad_fn(true, $elm$parser$Parser$Advanced$fromInfo_fn(s.F, s.B - (floatOffset + s.b), invalid, s.c));
  } else {
    if (_Utils_eq(s.b, floatOffset)) {
      return $elm$parser$Parser$Advanced$Bad_fn(false, $elm$parser$Parser$Advanced$fromState_fn(s, expecting));
    } else {
      if (_Utils_eq(intOffset, floatOffset)) {
        return $elm$parser$Parser$Advanced$finalizeInt_fn(invalid, intSettings, s.b, intPair, s);
      } else {
        if (floatSettings.$ === 1) {
          floatSettings.a;
          ...
          var _v1 = $elm$core$String$toFloat(_String_slice_fn(s.b, floatOffset, s.a));
          if (_v1.$ === 1) {
            return $elm$parser$Parser$Advanced$Bad_fn(true, $elm$parser$Parser$Advanced$fromState_fn(s, invalid));
          } else {
            var n = _v1.a;
...
var $elm$parser$Parser$Advanced$number = function(c) {
  return function(s) {
    if (_Parser_isAsciiCode_fn(48, s.b, s.a)) {
      var zeroOffset = s.b + 1;
      var baseOffset = zeroOffset + 1;
      return _Parser_isAsciiCode_fn(120, zeroOffset, s.a) ? $elm$parser$Parser$Advanced$finalizeInt_fn(c.a4, c.ai, baseOffset, _Parser_consumeBase16_fn(baseOffset, s.a), s) : _Parser_isAsciiCode_fn(111, zeroOffset, s.a) ? $elm$parser$Parser$Advanced$finalizeInt_fn(c.a4, c.ap, baseOffset, _Parser_consumeBase_fn(8, baseOffset, s.a), s) : _Parser_isAsciiCode_fn(98, zeroOffset, s.a) ? $elm$parser$Parser$Advanced$finalizeInt_fn(c.a4, c._, baseOffset, _Parser_consumeBase_fn(2, baseOffset, s.a), s) : $elm$parser$Parser$Advanced$finalizeFloat_fn(c.a4, c.ae, c.al, c.af, _Utils_Tuple2(zeroOffset, 0), s);
    } else {
      return $elm$parser$Parser$Advanced$finalizeFloat_fn(c.a4, c.ae, c.al, c.af, _Parser_consumeBase_fn(10, s.b, s.a), s);
    }
  };
};
...
F2($elm$parser$Parser$Advanced$int_fn);
...
var $elm$parser$Parser$Advanced$token = function(_v0) {
  ...
  return function(s) {
    var _v1 = _Parser_isSubString_fn(str, s.b, s.F, s.B, s.a);
    var newOffset = _v1.a;
    var newRow = _v1.b;
    var newCol = _v1.c;
    return newOffset === -1 ? $elm$parser$Parser$Advanced$Bad_fn(false, $elm$parser$Parser$Advanced$fromState_fn(s, expecting)) : $elm$parser$Parser$Advanced$Good_fn(progress, 0, { B: newCol, c: s.c, e: s.e, b: newOffset, F: newRow, a: s.a });
  };
};
...
var $kraklin$elm_debug_parser$DebugParser$parseBytes = function(config) {
  return $elm$parser$Parser$backtrackable($elm$parser$Parser$Advanced$keeper_fn($elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$succeed(config.aQ), $elm$parser$Parser$token("<")), $elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$int, $elm$parser$Parser$token(" bytes>"))));
};
...
var $kraklin$elm_debug_parser$DebugParser$parseChar = function(config) {
  return $elm$parser$Parser$oneOf(_List_fromArray([
    $elm$parser$Parser$Advanced$map_fn(function(_v0) {
      return config.aT("'");
    }, $elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$succeed($elm$core$Basics$identity), $elm$parser$Parser$token("'\\''"))),
    ...
    $elm$parser$Parser$Advanced$map_fn(function(_v3) {
      return config.aT("\v");
    }, $elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$succeed($elm$core$Basics$identity), $elm$parser$Parser$token("'\\v'"))),
    $elm$parser$Parser$Advanced$map_fn(function(_v4) {
      return config.aT("\r");
    }, $elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$succeed($elm$core$Basics$identity), $elm$parser$Parser$token("'\\r'"))),
    $elm$parser$Parser$Advanced$map_fn(function(_v5) {
      return config.aT("\0");
    }, $elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$succeed($elm$core$Basics$identity), $elm$parser$Parser$token("'\\0'"))),
    $elm$parser$Parser$Advanced$map_fn(A2($elm$core$Basics$composeR, $elm$core$String$toList, A2($elm$core$Basics$composeR, $elm$core$List$reverse, A2($elm$core$Basics$composeR, $elm$core$List$head, A2($elm$core$Basics$composeR, $elm$core$Maybe$withDefault("x"), config.aT)))), $elm$parser$Parser$Advanced$keeper_fn($elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$succeed($elm$core$Basics$identity), $elm$parser$Parser$token("'")), $elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$getChompedString($elm$parser$Parser$chompUntil("'")), $elm$parser$Parser$token("'"))))
  ]));
};
...
var $elm$parser$Parser$Advanced$chompIf_fn = function(isGood, expecting) {
  return function(s) {
    ...
    return newOffset === -1 ? $elm$parser$Parser$Advanced$Bad_fn(false, $elm$parser$Parser$Advanced$fromState_fn(s, expecting)) : newOffset === -2 ? $elm$parser$Parser$Advanced$Good_fn(true, 0, { B: 1, c: s.c, e: s.e, b: s.b + 1, F: s.F + 1, a: s.a }) : $elm$parser$Parser$Advanced$Good_fn(true, 0, { B: s.B + 1, c: s.c, e: s.e, b: newOffset, F: s.F, a: s.a });
  };
};
F2($elm$parser$Parser$Advanced$chompIf_fn);
...
var $elm$parser$Parser$Advanced$chompWhileHelp_fn = function(isGood, offset, row, col, s0) {
  chompWhileHelp:
    while (true) {
      ...
      if (newOffset === -1) {
        return $elm$parser$Parser$Advanced$Good_fn(_Utils_cmp(s0.b, offset) < 0, 0, { B: col, c: s0.c, e: s0.e, b: offset, F: row, a: s0.a });
      } else {
        if (newOffset === -2) {
...
F5($elm$parser$Parser$Advanced$chompWhileHelp_fn);
var $elm$parser$Parser$Advanced$chompWhile = function(isGood) {
  return function(s) {
    return $elm$parser$Parser$Advanced$chompWhileHelp_fn(isGood, s.b, s.F, s.B, s);
  };
};
var $elm$parser$Parser$chompWhile = $elm$parser$Parser$Advanced$chompWhile;
var $kraklin$elm_debug_parser$DebugParser$parseTypeName = $elm$parser$Parser$getChompedString($elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$succeed(0), $elm$parser$Parser$chompIf($elm$core$Char$isUpper)), $elm$parser$Parser$chompWhile(function(c) {
  return $elm$core$Char$isAlphaNum(c) || c === "_";
})));
var $kraklin$elm_debug_parser$DebugParser$parseCustomTypeWithoutValue = function(config) {
  return $elm$parser$Parser$Advanced$keeper_fn($elm$parser$Parser$succeed(function(name) {
    switch (name) {
      case "True":
        return config.aP(true);
      case "False":
        return config.aP(false);
      case "NaN":
        return config.a8(0 / 0);
      case "Infinity":
        return config.a8(1 / 0);
      default:
        return A2(config.aU, name, _List_Nil);
    }
...
var $kraklin$elm_debug_parser$DebugParser$addHex_fn = function(_char, total) {
  var code = $elm$core$Char$toCode(_char);
  return 48 <= code && code <= 57 ? 16 * total + (code - 48) : 65 <= code && code <= 70 ? 16 * total + (10 + code - 65) : 16 * total + (10 + code - 97);
}, $kraklin$elm_debug_parser$DebugParser$addHex = F2($kraklin$elm_debug_parser$DebugParser$addHex_fn);
var $elm$core$Char$fromCode = _Char_fromCode;
var $kraklin$elm_debug_parser$DebugParser$codeToChar = function(str) {
  var length = $elm$core$String$length(str);
  var code = _String_foldl_fn($kraklin$elm_debug_parser$DebugParser$addHex, 0, str);
  return 4 <= length && length <= 6 ? $elm$parser$Parser$problem("code point must have between 4 and 6 digits") : 0 <= code && code <= 1114111 ? $elm$parser$Parser$succeed($elm$core$Char$fromCode(code)) : $elm$parser$Parser$problem("code point must be between 0 and 0x10FFFF");
};
var $elm$core$Char$isHexDigit = function(_char) {
  var code = $elm$core$Char$toCode(_char);
  return 48 <= code && code <= 57 || (65 <= code && code <= 70 || 97 <= code && code <= 102);
};
var $kraklin$elm_debug_parser$DebugParser$unicode = $elm$parser$Parser$Advanced$andThen_fn($kraklin$elm_debug_parser$DebugParser$codeToChar, $elm$parser$Parser$getChompedString($elm$parser$Parser$chompWhile($elm$core$Char$isHexDigit)));
var $kraklin$elm_debug_parser$DebugParser$stringHelp_fn = function(endString, charCheckFn, revChunks) {
  return $elm$parser$Parser$oneOf(_List_fromArray([
    $elm$parser$Parser$Advanced$keeper_fn($elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$succeed(function(chunk) {
      return $elm$parser$Parser$Loop(_List_Cons(chunk, revChunks));
    }), $elm$parser$Parser$token("\\")), $elm$parser$Parser$oneOf(_List_fromArray([
      $elm$parser$Parser$Advanced$map_fn(function(_v0) {
        return "\n";
      ...
      $elm$parser$Parser$Advanced$map_fn(function(_v6) {
        return '"';
      }, $elm$parser$Parser$token('"')),
      $elm$parser$Parser$Advanced$keeper_fn($elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$succeed($elm$core$String$fromChar), $elm$parser$Parser$token("u{")), $elm$parser$Parser$Advanced$ignorer_fn($kraklin$elm_debug_parser$DebugParser$unicode, $elm$parser$Parser$token("}")))
    ]))),
    $elm$parser$Parser$oneOf(_List_fromArray([
      $elm$parser$Parser$Advanced$map_fn(function(_v7) {
        return $elm$parser$Parser$Done($elm$core$Maybe$Just($elm$core$String$concat($elm$core$List$reverse(revChunks))));
      }, $elm$parser$Parser$token(endString)),
      $elm$parser$Parser$Advanced$map_fn(function(_v8) {
        return $elm$parser$Parser$Done($elm$core$Maybe$Nothing);
      }, $elm$parser$Parser$end)
    ])),
    $elm$parser$Parser$Advanced$map_fn(function(chunk) {
      return $elm$parser$Parser$Loop(_List_Cons(chunk, revChunks));
    }, $elm$parser$Parser$getChompedString($elm$parser$Parser$chompWhile(charCheckFn)))
  ]));
}, $kraklin$elm_debug_parser$DebugParser$stringHelp = F3($kraklin$elm_debug_parser$DebugParser$stringHelp_fn);
var $kraklin$elm_debug_parser$DebugParser$parseFile = function(config) {
  return $elm$parser$Parser$Advanced$andThen_fn(A2($elm$core$Basics$composeR, $elm$core$Maybe$map(function(str) {
    return $elm$parser$Parser$succeed(config.a_(str));
  }), $elm$core$Maybe$withDefault($elm$parser$Parser$problem("File has no closing bracket"))), $elm$parser$Parser$Advanced$keeper_fn($elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$succeed($elm$core$Basics$identity), $elm$parser$Parser$token("<")), $elm$parser$Parser$loop_fn(_List_Nil, A2($kraklin$elm_debug_parser$DebugParser$stringHelp, ">", function(c) {
    return c !== ">";
  }))));
};
...
var $elm$parser$Parser$Advanced$keyword = function(_v0) {
  ...
  return function(s) {
    var _v1 = _Parser_isSubString_fn(kwd, s.b, s.F, s.B, s.a);
    var newOffset = _v1.a;
    var newRow = _v1.b;
    var newCol = _v1.c;
    return newOffset === -1 || 0 <= _Parser_isSubChar_fn(function(c) {
      return $elm$core$Char$isAlphaNum(c) || c === "_";
    }, newOffset, s.a) ? $elm$parser$Parser$Advanced$Bad_fn(false, $elm$parser$Parser$Advanced$fromState_fn(s, expecting)) : $elm$parser$Parser$Advanced$Good_fn(progress, 0, { B: newCol, c: s.c, e: s.e, b: newOffset, F: newRow, a: s.a });
  };
};
...
var $kraklin$elm_debug_parser$DebugParser$parseKeywords = function(config) {
  return $elm$parser$Parser$oneOf(_List_fromArray([
    $elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$succeed(config.a3), $elm$parser$Parser$keyword("<internals>")),
    $elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$succeed(config.a$), $elm$parser$Parser$keyword("<function>"))
  ]));
};
...
var $kraklin$elm_debug_parser$DebugParser$parseNumber = function(config) {
  var number = $elm$parser$Parser$Advanced$andThen_fn(function(str) {
  ...
  }, $elm$parser$Parser$getChompedString($elm$parser$Parser$chompWhile(function(_char) {
    return $elm$core$Char$isDigit(_char) || (_char === "." || (_char === "+" || (_char === "e" || _char === "-")));
  })));
  return $elm$parser$Parser$Advanced$map_fn(config.a8, $elm$parser$Parser$oneOf(_List_fromArray([
    $elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$succeed(0 / 0), $elm$parser$Parser$keyword("NaN")),
    $elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$succeed(1 / 0), $elm$parser$Parser$keyword("Infinity")),
    $elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$succeed(-(1 / 0)), $elm$parser$Parser$keyword("-Infinity")),
    $elm$parser$Parser$oneOf(_List_fromArray([
      $elm$parser$Parser$Advanced$keeper_fn($elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$succeed($elm$core$Basics$negate), $elm$parser$Parser$symbol("-")), number),
      number
    ]))
  ])));
};
...
var $kraklin$elm_debug_parser$DebugParser$parseString = function(config) {
  return $elm$parser$Parser$Advanced$andThen_fn(A2($elm$core$Basics$composeR, $elm$core$Maybe$map(function(str) {
    return $elm$parser$Parser$succeed(config.bg(str));
  }), $elm$core$Maybe$withDefault($elm$parser$Parser$problem("One string has no closing double quotes"))), $elm$parser$Parser$Advanced$keeper_fn($elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$succeed($elm$core$Basics$identity), $elm$parser$Parser$token('"')), $elm$parser$Parser$loop_fn(_List_Nil, A2($kraklin$elm_debug_parser$DebugParser$stringHelp, '"', $kraklin$elm_debug_parser$DebugParser$isUninteresting))));
};
var $kraklin$elm_debug_parser$DebugParser$parseVariableName = $elm$parser$Parser$getChompedString($elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$succeed(0), $elm$parser$Parser$chompIf($elm$core$Char$isLower)), $elm$parser$Parser$chompWhile(function(c) {
  return $elm$core$Char$isAlphaNum(c) || c === "_";
})));
...
F2($elm$parser$Parser$Advanced$skip_fn);
...
F5($elm$parser$Parser$Advanced$sequenceEnd_fn);
var $elm$parser$Parser$Advanced$sequence = function(i) {
  return $elm$parser$Parser$Advanced$skip_fn($elm$parser$Parser$Advanced$token(i.W), $elm$parser$Parser$Advanced$skip_fn(i.aC, $elm$parser$Parser$Advanced$sequenceEnd_fn($elm$parser$Parser$Advanced$token(i.ac), i.aC, i.am, $elm$parser$Parser$Advanced$token(i.aB), i.aF)));
};
...
var $elm$parser$Parser$sequence = function(i) {
  return $elm$parser$Parser$Advanced$sequence({
    ...
    aF: $elm$parser$Parser$toAdvancedTrailing(i.aF)
  });
};
...
var $kraklin$elm_debug_parser$DebugParser$parseArray = function(config) {
  return $elm$parser$Parser$Advanced$map_fn(config.aN, $elm$parser$Parser$sequence({
    ac: "]",
    am: $elm$parser$Parser$lazy(function(_v10) {
      return $kraklin$elm_debug_parser$DebugParser$parseValueWith(config);
    }),
    aB: ",",
    aC: $elm$parser$Parser$spaces,
    W: "Array.fromList [",
    aF: 0
  }));
};
var $kraklin$elm_debug_parser$DebugParser$parseCustomType = function(config) {
  return $elm$parser$Parser$Advanced$andThen_fn(function(name) {
    switch (name) {
      case "True":
        return $elm$parser$Parser$succeed(config.aP(true));
      case "False":
        return $elm$parser$Parser$succeed(config.aP(false));
      case "NaN":
        return $elm$parser$Parser$succeed(config.a8(0 / 0));
      case "Infinity":
        return $elm$parser$Parser$succeed(config.a8(1 / 0));
      default:
        return $elm$parser$Parser$Advanced$keeper_fn($elm$parser$Parser$succeed(function(list) {
          return A2(config.aU, name, $elm$core$List$reverse(list));
        }), $elm$parser$Parser$loop_fn(_List_Nil, $kraklin$elm_debug_parser$DebugParser$typeHelp(config)));
    }
  }, $kraklin$elm_debug_parser$DebugParser$parseTypeName);
};
var $kraklin$elm_debug_parser$DebugParser$parseDict = function(config) {
  return $elm$parser$Parser$Advanced$map_fn(config.aW, $elm$parser$Parser$sequence({
    ac: "]",
    am: $elm$parser$Parser$lazy(function(_v7) {
      return $elm$parser$Parser$Advanced$keeper_fn($elm$parser$Parser$Advanced$keeper_fn($elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$succeed($elm$core$Tuple$pair), $elm$parser$Parser$token("(")), $elm$parser$Parser$spaces), $elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$lazy(function(_v8) {
        return $kraklin$elm_debug_parser$DebugParser$parseValueWith(config);
      }), $elm$parser$Parser$spaces), $elm$parser$Parser$token(",")), $elm$parser$Parser$spaces)), $elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$Advanced$ignorer_fn($kraklin$elm_debug_parser$DebugParser$parseValueWith(config), $elm$parser$Parser$spaces), $elm$parser$Parser$token(")")));
    }),
    aB: ",",
    aC: $elm$parser$Parser$spaces,
    W: "Dict.fromList [",
...
var $kraklin$elm_debug_parser$DebugParser$parseList = function(config) {
  return $elm$parser$Parser$Advanced$map_fn(function(listVal) {
    return config.a5(listVal);
  }, $elm$parser$Parser$sequence({
    ac: "]",
    am: $elm$parser$Parser$lazy(function(_v6) {
      return $kraklin$elm_debug_parser$DebugParser$parseValueWith(config);
    }),
    aB: ",",
    aC: $elm$parser$Parser$spaces,
...
var $kraklin$elm_debug_parser$DebugParser$parseRecord = function(config) {
  return $elm$parser$Parser$Advanced$map_fn(config.bd, $elm$parser$Parser$sequence({
    ac: "}",
    am: $elm$parser$Parser$lazy(function(_v5) {
      return $elm$parser$Parser$Advanced$keeper_fn($elm$parser$Parser$Advanced$keeper_fn($elm$parser$Parser$succeed($elm$core$Tuple$pair), $elm$parser$Parser$Advanced$ignorer_fn($kraklin$elm_debug_parser$DebugParser$parseVariableName, $elm$parser$Parser$token(" = "))), $kraklin$elm_debug_parser$DebugParser$parseValueWith(config));
    }),
    aB: ",",
    aC: $elm$parser$Parser$spaces,
    W: "{",
...
var $kraklin$elm_debug_parser$DebugParser$parseSet = function(config) {
  return $elm$parser$Parser$Advanced$map_fn(config.bf, $elm$parser$Parser$sequence({
    ac: "]",
    am: $elm$parser$Parser$lazy(function(_v4) {
      return $kraklin$elm_debug_parser$DebugParser$parseValueWith(config);
    }),
    aB: ",",
    aC: $elm$parser$Parser$spaces,
...
var $kraklin$elm_debug_parser$DebugParser$parseValueWith = function(config) {
  return $elm$parser$Parser$oneOf(_List_fromArray([
    ...
    $elm$parser$Parser$lazy(function(_v3) {
...
var $kraklin$elm_debug_parser$DebugParser$parseValueWithParenthesis = function(config) {
  return $elm$parser$Parser$Advanced$keeper_fn($elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$succeed($elm$core$Basics$identity), $elm$parser$Parser$token("(")), $elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$oneOf(_List_fromArray([
    $elm$parser$Parser$Advanced$andThen_fn(function(fstValue) {
      return $elm$parser$Parser$oneOf(_List_fromArray([
        $elm$parser$Parser$Advanced$andThen_fn(function(sndValue) {
          return $elm$parser$Parser$Advanced$keeper_fn($elm$parser$Parser$succeed($elm$core$Basics$identity), $elm$parser$Parser$oneOf(_List_fromArray([
            $elm$parser$Parser$Advanced$map_fn(function(rdValue) {
              return config.bl(_List_fromArray([fstValue, sndValue, rdValue]));
            }, $elm$parser$Parser$Advanced$keeper_fn($elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$succeed($elm$core$Basics$identity), $elm$parser$Parser$spaces), $elm$parser$Parser$token(",")), $elm$parser$Parser$spaces), $elm$parser$Parser$lazy(function(_v2) {
              return $kraklin$elm_debug_parser$DebugParser$parseValueWith(config);
            }))),
            $elm$parser$Parser$succeed(config.bl(_List_fromArray([fstValue, sndValue])))
          ])));
        }, $elm$parser$Parser$Advanced$keeper_fn($elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$succeed($elm$core$Basics$identity), $elm$parser$Parser$spaces), $elm$parser$Parser$token(",")), $elm$parser$Parser$spaces), $elm$parser$Parser$lazy(function(_v1) {
          return $kraklin$elm_debug_parser$DebugParser$parseValueWith(config);
        }))),
        $elm$parser$Parser$succeed(fstValue)
      ]));
    }, $elm$parser$Parser$Advanced$keeper_fn($elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$succeed($elm$core$Basics$identity), $elm$parser$Parser$spaces), $elm$parser$Parser$lazy(function(_v0) {
      return $kraklin$elm_debug_parser$DebugParser$parseValueWith(config);
    }))),
    $elm$parser$Parser$succeed(config.bm)
  ])), $elm$parser$Parser$token(")")));
};
...
var $kraklin$elm_debug_parser$DebugParser$typeHelp_fn = function(config, values) {
  return $elm$parser$Parser$oneOf(_List_fromArray([
    $elm$parser$Parser$backtrackable($elm$parser$Parser$Advanced$keeper_fn($elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$succeed(function(value) {
      return $elm$parser$Parser$Loop(_List_Cons(value, values));
    }), $elm$parser$Parser$token(" ")), $kraklin$elm_debug_parser$DebugParser$parseValueWithoutCustomType(config))),
    $elm$parser$Parser$succeed($elm$parser$Parser$Done(values))
  ]));
}, $kraklin$elm_debug_parser$DebugParser$typeHelp = F2($kraklin$elm_debug_parser$DebugParser$typeHelp_fn);
var $elm$parser$Parser$DeadEnd_fn = function(row, col, problem) {
  return { B: col, E: problem, F: row };
};
F3($elm$parser$Parser$DeadEnd_fn);
var $elm$parser$Parser$problemToDeadEnd = function(p) {
  return $elm$parser$Parser$DeadEnd_fn(p.F, p.B, p.E);
};
...
F2($elm$parser$Parser$Advanced$bagToList_fn);
var $elm$parser$Parser$Advanced$run_fn = function(_v0, src) {
  var parse2 = _v0;
  var _v1 = parse2({ B: 1, c: _List_Nil, e: 1, b: 0, F: 1, a: src });
  if (!_v1.$) {
    var value = _v1.b;
...
F2($elm$parser$Parser$Advanced$run_fn);
...
F2($elm$parser$Parser$run_fn);
var $elm$core$String$trim = _String_trim;
var $kraklin$elm_debug_parser$DebugParser$parse_fn = function(config, stringToParse) {
  return $elm$core$Result$mapError_fn($kraklin$elm_debug_parser$DebugParser$deadEndsToString, $elm$parser$Parser$run_fn($elm$parser$Parser$Advanced$keeper_fn($elm$parser$Parser$Advanced$keeper_fn($elm$parser$Parser$succeed($kraklin$elm_debug_parser$DebugParser$ParsedLog), $elm$parser$Parser$Advanced$ignorer_fn($elm$parser$Parser$getChompedString($elm$parser$Parser$chompUntil(": ")), $elm$parser$Parser$token(": "))), $elm$parser$Parser$Advanced$ignorer_fn($kraklin$elm_debug_parser$DebugParser$parseValueWith(config), $elm$parser$Parser$end)), $elm$core$String$trim(stringToParse)));
};
F2($kraklin$elm_debug_parser$DebugParser$parse_fn);
...
var $author$project$Parser$init = function(message) {
  var _v0 = $kraklin$elm_debug_parser$DebugParser$parse_fn($author$project$Parser$config, message);
  if (!_v0.$) {
    var tag = _v0.a.bi;
    var value = _v0.a.bo;
    return _Utils_Tuple2(0, $author$project$Parser$sendParsed($elm$json$Json$Encode$object(_List_fromArray([
      _Utils_Tuple2("type", $elm$json$Json$Encode$string("ElmDebug")),
      _Utils_Tuple2("name", $elm$json$Json$Encode$string(tag)),
      _Utils_Tuple2("value", value)
    ]))));
  } else {
    var error = _v0.a;
    return _Utils_Tuple2(0, $author$project$Parser$sendParsed($elm$json$Json$Encode$object(_List_fromArray([
      _Utils_Tuple2("error", $elm$json$Json$Encode$string(error))
    ]))));
  }
};
...
var $author$project$Parser$subscriptions = function(_v0) {
  return $author$project$Parser$parse($elm$core$Basics$identity);
};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Parser$update_fn = function(msg, _v0) {
  return _Utils_Tuple2(0, $elm$core$Platform$Cmd$none);
}, $author$project$Parser$update = F2($author$project$Parser$update_fn);
var $elm$core$Platform$worker = _Platform_worker;
var $author$project$Parser$main_a0 = { a2: $author$project$Parser$init, bh: $author$project$Parser$subscriptions, bn: $author$project$Parser$update }, $author$project$Parser$main = $elm$core$Platform$worker($author$project$Parser$main_a0);
